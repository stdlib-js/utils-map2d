...
```javascript
map2d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-map2d@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-map2d@umd/bundle.js"></script>
```
